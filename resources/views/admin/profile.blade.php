...
@section('content')
<section class="flex flex-col justify-center items-center relative py-4">
    <div class="flex flex-col justify-center bg-gray-200 dark:bg-gray-800 w-full md:w-[90%] rounded-3xl">
        ...
        <div class="w-full flex flex-col items-center my-4">
                <h2 class="font-poppins font-semibold text-[32px] text-gray-900 dark:text-gray-100 align-middle">
                    {{ Auth::user()->username }}
                </h2>
        </div>
            ...
            <form action=" {{ route('change.password') }} " method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="old_password" id="password" placeholder="••••••••"
                                    class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-[18px] md:text-[24px] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-[90%] md:w-[50%] p-2.5"
                                    required>
                </div> 
                <div class="mb-6">
                ...
                <div class="mb-2">
                    <button type="submit" class="px-4 py-3 font-poppins font-semibold text-white text-[18px] bg-blue-600 capitalize rounded-xl">
                        change
                    </button>    
                </div> 
            </form>
