                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2 ml-2">
                            <div>
                                ...
                                <input name="teamA_id" type="number" id="nama_ketua"
                                    ...
                                    value="{{ $jadwal->teamA_id }}" required>
                            </div>
                            <div>
                                <label for="Team"
                                ...
                                <input name="teamB_id" type="number" id="nama_ketua"
                                    class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    value="{{ $jadwal->teamB_id }}" required>
                            </div>
                            <div>
                                <label for="Team"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Score A</label>
                                <input name="ScoreA" type="number" id="nama_ketua"
                                    class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    value="{{ $jadwal->ScoreA }}" required>
                            </div>
                            <div>
                                <label for="Team"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Score B</label>
                                <input name="ScoreB" type="number" id="nama_ketua"
                                    class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    value="{{ $jadwal->ScoreB }}" required>
                            </div>
                            <div>
                                <label for="Team"
